...
urlpatterns = [  # pylint: disable=invalid-name
    ...
    path('expense/<int:expense_id>/pdf/', views.base.deprecated_view, name="expense_claim"),
    path('expense/<int:expense_id>/review/', views.expense_review, name="expense_review"),
    path('expense/<int:expense_id>/', views.base.deprecated_view, name="expense_detail"),
