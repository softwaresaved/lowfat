...
FUND_PATTERNS = [
    ...
    url(r'^(?P<fund_id>[0-9]+)/reply', views.fund_reply, name="fund_reply"),
...
urlpatterns = [  # pylint: disable=invalid-name
    ...
    url(r'^expense/(?P<expense_id>[0-9\-]+)/reply', views.expense_reply, name="expense_reply"),
    ...
    url(r'^blog/(?P<blog_id>[0-9]+)/reply', views.blog_reply, name="blog_reply"),
