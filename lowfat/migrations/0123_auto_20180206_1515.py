...
def create_past_terms_and_conditions(apps, schema_editor):
    old_documents = [
    ...
    TermsAndConditions = apps.get_model("lowfat", "TermsAndConditions")
...
def reverse_create_past_terms_and_conditions(apps, schema_editor):
    pass
