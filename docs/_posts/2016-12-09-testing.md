...
<div class="doc-pagination">
  <a class="doc-prev" href="{{ site.baseurl }}{% post_url 2017-07-25-url %}">
    <span class="arrow">←</span>
    <span class="label">Style Guide and URL</span>
  </a>

  <a class="doc-next" href="{{ site.baseurl }}{% post_url 2022-11-01-dev-process %}">
    <span class="label">Development Cycle</span>
    <span class="arrow">→</span>
  </a>
</div>