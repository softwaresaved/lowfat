---
layout: page
title: "Processing Expense Claims"
category: staff
order: 4
---
...
<div class="box-note">
<strong>For the advance booking:</strong><br>
Fellows should email:  
...
<div style="max-height: 550px; overflow-y: auto; border: 1px solid #ddd;">
  <img src="{{ site.baseurl }}/img/expense-review-2026.png" style="width:100%;">
</div>
</div>
...
<div class="doc-pagination">
  <a class="doc-prev" href="{{ site.baseurl }}{% post_url 2017-03-14-request-review %}">
    <span class="arrow">←</span>
    <span class="label">Reviewing Funding Requests</span>
  </a>

  <a class="doc-next" href="{{ site.baseurl }}{% post_url 2017-03-14-blog-review %}">
